...
folder are mapped to the application's root namespace, 'Stratege'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Stratege' in the same way
as `"Stratege/sass/src"`.
